	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						<h1><a href="index.php">Roberto alexis and Julio flores</a></h1>
						<!-- <nav class="links">
							<ul>
					...
					<div id="main">
						...
						<!-- Post -->
							<article class="post">
								...
								<footer>
									<ul class="actions">
										<li><a href="singleJ.php" class="button large">Continuar Leyendo</a></li>
									</ul>
									<ul class="stats">
						...
						<!-- Post -->
							<article class="post">
								<header>
									<div class="title">
										<h2><a href="single.php">Definir los sitemas de conexión libre y a travez de redes...</a></h2>
										<p>Introducción a la arquitectura Cliente-Servidor</p>
									</div>
									<div class="meta">
								...
								<a href="single.php" class="image featured"><img src="images/p1.jpg" alt="" /></a>
						...
						<!-- Post -->
							<article class="post">
								<header>
									<div class="title">
										<h2><a href="single two.php">Describir los sistemas con arquitectura Cliente / Servidor</a></h2>
										<p>Introducción a la arquitectura Cliente-Servidor</p>
									</div>
									<div class="meta">
								...
								<footer>
									<ul class="actions">
										<li><a href="single two.php" class="button large">Continuar Leyendo</a></li>
									</ul>
									<ul class="stats">
										<li><a href="#">General</a></li>
										<li><a href="#" class="icon solid fa-heart">28</a></li>
					...
					<section id="sidebar">
						...
						<!-- Intro -->
							<section id="intro">
								...
								<header>
									<h2 style="color: brown;">ALERTAS UPT</h2>
									<p>Examen de cliente servidor... </p>
								</header>
							</section>
								...
								<div class="mini-posts">
									...
									<!-- Mini Post -->
										<article class="mini-post">
											<header>
												<h3><a href="single three.php">Reconocer protocolos de comunicación de red</a></h3>
												<time class="published" datetime="2015-10-20">October 20, 2015</time>
												<a href="" class="author"><img src="images/avatar.jpg" alt="" /></a>
											</header>
											<a href="single three.php" class="image"><img src="images/p3.jpg" alt="" /></a>
										</article>

									<!-- Mini Post -->
										<article class="mini-post">
											<header>
												<h3><a href="single four.php">Clasificar los sitemas de información de acuerdo a su arquitectura</a></h3>
												<time class="published" datetime="2015-10-19">October 19, 2015</time>
												<a href="#" class="author"><img src="images/avatar.jpg" alt="" /></a>
											</header>
											<a href="single four.php" class="image"><img src="images/p4.jpg" alt="" /></a>
										</article>
